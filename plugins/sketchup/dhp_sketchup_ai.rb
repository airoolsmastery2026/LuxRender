...
module DaiHaiPhat
  module SketchUpAI
    ...
    EXTENSION_VERSION = '0.8.0'.freeze
    EXTENSION_ID = 'com.daihaiphat.sketchup_ai'.freeze

    unless file_loaded?(__FILE__)
      extension = SketchupExtension.new(EXTENSION_NAME, 'dhp_sketchup_ai/main')
      extension.description = 'LuxRender SketchUp adapter with cloud Gemini failover, actionable local ComfyUI bootstrap, diagnostics, compare and project render history.'
